...
from functions.iteration_funcs import get_gp_models, get_multistage_cost_models, get_cost_model, get_inv_cost_models
from optimize_mem_acqf import optimize_acqf_by_mem
from botorch.sampling import SobolQMCNormalSampler
from botorch.acquisition.objective import IdentityMCObjective

def carbo_iteration(X, y, c, bounds=None, acqf_str='', decay=None, iter=None, consumed_budget=None, params=None):
